/*
 * ISS Pass Prediction and Location Display for
 * FireBeetle ESP32 and LED Matrix
 * 
 * version 1.0.0 - June 1, 2018
 * Known Issues: SmartConfig doesn't work as expected.
 * Sketch polls the open-notify api on each loop (Fixed 
 * in example with task controls).
 * 
 * See below for more information on setup.
 *  * 
