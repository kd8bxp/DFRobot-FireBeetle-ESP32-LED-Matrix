...
void fireworks(int x) {  
  ...
  ht1632c.drawImage(i1,8,8,x+8,0,0);
  ht1632c.writeScreen();
  delay(wait*0.2);
  ht1632c.drawImage(i2,8,8,x,0,0);
  ht1632c.drawImage(i2,8,8,x+8,0,0);
  ht1632c.writeScreen();
  delay(wait*0.2);
  ht1632c.drawImage(i3,8,8,x,0,0);
  ht1632c.drawImage(i3,8,8,x+8,0,0);
  ht1632c.writeScreen();
  delay(wait*0.2);
  ht1632c.drawImage(i4,8,8,x,0,0);
  ht1632c.drawImage(i4,8,8,x+8,0,0);
  ht1632c.writeScreen();
  delay(wait*0.2);
  ht1632c.drawImage(i5,8,8,x,0,0);
  ht1632c.drawImage(i5,8,8,x+8,0,0);
  ht1632c.writeScreen();
  delay(wait*0.2);
  ht1632c.drawImage(i6,8,8,x,0,0);
  ht1632c.drawImage(i6,8,8,x+8,0,0);
  ht1632c.writeScreen();
  delay(wait*0.2);
  ht1632c.drawImage(i7,8,8,x,0,0);
  ht1632c.drawImage(i7,8,8,x+8,0,0);
  ht1632c.writeScreen();
  delay(wait*0.2);
  ht1632c.drawImage(i8,8,8,x,0,0);
  ht1632c.drawImage(i8,8,8,x+8,0,0);
  ht1632c.writeScreen();
  delay(wait*0.2);
  ht1632c.drawImage(i9,8,8,x,0,0);
  ht1632c.drawImage(i9,8,8,x+8,0,0);
  ht1632c.writeScreen();
  delay(wait*0.2);
  ht1632c.drawImage(i10,8,8,x,0,0);
  ht1632c.drawImage(i10,8,8,x+8,0,0);
  ht1632c.writeScreen();
  delay(wait*0.2);
  ht1632c.drawImage(i11,8,8,x,0,0);
  ht1632c.drawImage(i11,8,8,x+8,0,0);
  ht1632c.writeScreen();
  delay(wait*0.2);
  ht1632c.drawImage(i12,8,8,x,0,0);
  ht1632c.drawImage(i12,8,8,x+8,0,0);
  ht1632c.writeScreen();
  delay(wait*0.2);
  ht1632c.drawImage(i13,8,8,x,0,0);
  ht1632c.drawImage(i13,8,8,x+8,0,0);
  ht1632c.writeScreen();
  delay(wait*0.2);
  ht1632c.drawImage(i14,8,8,x,0,0);
  ht1632c.drawImage(i14,8,8,x+8,0,0);
  ht1632c.writeScreen();
  delay(wait*0.2);
